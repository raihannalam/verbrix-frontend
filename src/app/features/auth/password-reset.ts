          ...
          <form [formGroup]="form" class="space-y-6">
            ...
            @if (step() === 'enterEmail') {
              <div class="space-y-2">
                ...
                <div class="relative">
                  <input type="email" formControlName="email" class="w-full h-12 pl-10 px-4 rounded-xl bg-bg-surface border border-transparent text-text-main focus:bg-bg-page focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none transition-all placeholder:text-text-dim" placeholder="name@company.com" />
              ...
              <button type="button" (click)="requestOtp()" [disabled]="loading() || form.controls.email.invalid" class="w-full h-12 rounded-xl bg-brand text-white font-bold text-base shadow-lg hover:bg-brand-hover active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center">
            ...
            @if (step() === 'enteredOtp') {
              <div class="space-y-4">
                ...
                <button type="button" (click)="verifyOtp()" [disabled]="loading() || form.controls.otp.invalid" class="w-full h-12 rounded-xl bg-brand text-white font-bold text-base shadow-lg hover:bg-brand-hover active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center mt-2">
            ...
            @if (step() === 'setPassword') {
              <div class="space-y-4">
                ...
                <button type="button" (click)="resetPassword()" [disabled]="loading() || form.controls.newPassword.invalid" class="w-full h-12 rounded-xl bg-brand text-white font-bold text-base shadow-lg hover:bg-brand-hover active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center mt-4">
