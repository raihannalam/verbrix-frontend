    ...
    <main class="w-full bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans antialiased transition-colors duration-300">
      ...
      <section class="py-24 relative bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800">
        <div class="max-w-4xl mx-auto px-4 text-center">
          ...
          <a href="mailto:careers@verbrix.com" class="inline-flex items-center justify-center h-14 px-10 rounded-xl bg-violet-600 text-white font-semibold text-lg hover:bg-violet-500 hover:shadow-xl hover:shadow-violet-600/20 transition-all transform hover:-translate-y-1 active:scale-95">
            Contact Us
          </a>
        </div>
      </section>
